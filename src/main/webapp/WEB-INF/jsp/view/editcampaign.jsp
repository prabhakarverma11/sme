...
<div class="row breadcrumb">
	<a class="breadcrumb-item" href="${pageContext.request.contextPath}/listcampaign">
				Advertiser List</a> >> <a class="breadcrumb-item" href="${pageContext.request.contextPath}/listadgroup?cid=${campaignDo.id}">
				<c:out value="${campaignDo.name }" /></a> >> <span class="active"> Edit Advertiser</span>
</div>
<div class="auto-1000">
	...
	<div class="main-containter">
		...
		<form:form class="form-horizontal"  onsubmit="return validateForm();"  role="form" method="post"
			action="updatecampaign?cpage=${cpage}&rows=${rows }" modelAttribute="campaignDo" id="campaignform">
			...
			<input type="hidden" name="oldCampaignName" value="${oldCampaignName}"/>
			<div class="container">
						...
						<div class="col-lg-6" id="rdButtonInclude">
							<label class="col-sm-2 radio-inline">
								<form:radiobutton
									...
									value="1" checked="checked" /> All</label>
							<label
								class="col-sm-2 radio-inline">
								<form:radiobutton
									path="locationIncludeCriteria" id="idIncludeIndia"
									value="2" /> India</label>
							<label
								class="col-sm-3 radio-inline">
								<form:radiobutton
									path="locationIncludeCriteria" id="idLetMeChooseInclude"
									 value="3" /> Let Me Choose</label>
							<label
								class="col-sm-4 radio-inline">
								<form:radiobutton
									id="idIncludeRadiusTargeting" path="locationIncludeCriteria"
									value="4" /> Radius Targeting</label>
...
<div class="row" id="divIncludeRadius">
					<div class="form-group" style="float: center">
							...
							<div id="suggestboxIncludeRadius" class="col-lg-6 col-lg-offset-2 adsIncludeRadius"
								...
								<span class="input-group-addon"><i
									class="glyphicon glyphicon-search"
									style="width: 15px; height: 14px;"></i></span>
								<form:input type="text" class="form-control searchBoxIncludeRadius"
									id="searchBoxIncludeRadius" path="" placeholder="Search Locations" />
				...
				<div class="row" id="idShowCustomLocation" style="display: none;">
					<div class="form-group">
						<div class="col-lg-11 col-lg-offset-2" >No more locations.
							<span class="classClickHere" style="color: blue;cursor: pointer;text-decoration: underline;" >Click here</span> to add custom location.</div>
					</div>
				</div>
				...
				<div class="col-lg-4">
				<input type="text"  class="form-control"  id="idStreet" path="" value="" placeholder="Street Address"/>
				</div>
				...
				<div class="col-lg-2 col-lg-offset-2">
				<form:input type="text"  class="form-control"   id="idCity" path="" value="" placeholder="City"  />
				</div>
			
				<div class="col-lg-2">
				<form:input type="text"  class="form-control"   id="idState" path=""  value="" placeholder="State"/>
				</div>
				
				<div class="col-lg-2">
					<form:input type="text" path="" maxlength="6" pattern="\d{6}" title="Please enter a valid 6 digits postal code" class="form-control" id="idPostal" />
			...
			<div class="row" id="divRadiusAndKm">
				<div class="form-group">
				<div class="col-lg-2 col-lg-offset-2">
				<form:input type="number" class="form-control" path="" min="0" id="idRadius" placeholder="Radius" />
				</div>
				<div class="col-lg-1">
				...
				<div class="row" id="idSelectFromExistingLocations" style="display: none;">
					<div class="form-group">
						<div class="col-lg-11 col-lg-offset-2" >
							<span class="classExistingLocations" style="color: blue;cursor: pointer;text-decoration: underline;" >
							Click Here</span> to select from existing locations</div>
					</div>
				</div>
						...
						<div class="col-lg-6" id="rdButtonExclude">
							<label class="col-sm-2 radio-inline">
								<form:radiobutton
									...
									value="1" checked='checked' /> None</label>
							<label class="col-sm-2 radio-inline">
								<form:radiobutton
									id="idExcludeIndia" path="locationExcludeCriteria"
									value="2" /> India</label>
							<label
								class="col-sm-3 radio-inline">
								<form:radiobutton
						...
						<div class="col-lg-6">
							...
							<div class="input-group">
								<label class="input-group-addon btn" for="idStartDate">
									...
									style="width: 15px; height: 14px;"></span>
								</label>
				...
				<div class="row">
					<div class="form-group">
						...
						<div class="col-lg-6">
							<font color="red"></font>
							<div class="input-group">
								<label class="input-group-addon btn" for="idEndDate">
									<span class="fa fa-calendar"
									style="width: 15px; height: 14px;"></span>
								</label>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-10">
							<button type="submit"  id="idButton"  class="btn btn-success btnSubmitCampaign" data-loading-text="Updating Campaign...">
								Save and Update <span
